...
class BellScheduleSeeder extends Seeder
{
    public function run(): void
    {
        $audioMap = [
            ...
            '5 Menit Akhir Istirahat 2' => '5_menit_akhir_istirahat_2.wav',
        ...
        $monday = [
            ['time' => '07:10', 'name' => '5 Menit Awal Upacara'],
            ...
            ['time' => '11:45', 'name' => 'Jam ke-7'],
            ['time' => '12:25', 'name' => 'Istirahat 2'],
            ['time' => '12:55', 'name' => '5 Menit Akhir Istirahat 2'],
            ['time' => '13:00', 'name' => 'Jam ke-8'],
            ['time' => '13:40', 'name' => 'Jam ke-9'],
            ['time' => '14:20', 'name' => 'Jam ke-10'],
            ['time' => '15:00', 'name' => 'Jam ke-11'],
        ...
        $friday = [
            ['time' => '07:25', 'name' => '5 Menit Awal Jam ke-1'],
            ['time' => '07:30', 'name' => 'Jam ke-1'],
            ['time' => '08:00', 'name' => 'Jam ke-2'],
            ['time' => '08:40', 'name' => 'Jam ke-3'],
            ['time' => '09:20', 'name' => 'Istirahat'],
            ['time' => '09:30', 'name' => 'Akhir Istirahat'],
            ['time' => '09:35', 'name' => 'Jam ke-4'],
            ['time' => '10:00', 'name' => 'Lagu Indonesia Raya'],
            ['time' => '10:05', 'name' => 'Jam ke-5'],
            ['time' => '10:45', 'name' => 'Jam ke-6'],
            ['time' => '11:25', 'name' => 'Pulang'],
        ];
